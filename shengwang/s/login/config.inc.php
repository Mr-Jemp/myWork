...
define('UC_DBHOST', '192.168.1.236');			// UCenter 数据库主机
...
//通信相关
define('UC_KEY', 'kenzo');				// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost:809/uc');	// UCenter 的 URL 地址, 在调用头像时依赖此常量
define('UC_CHARSET', 'utf-8');				// UCenter 的字符集
define('UC_IP','');					// UCenter 的 IP, 当 UC_CONNECT 为非 mysql 方式时, 并且当前应用服务器解析域名有问题时, 请设置此值
define('UC_APPID',2);					// 当前应用的 ID

//ucexample_2.php 用到的应用程序数据库连接参数
$dbhost = '192.168.1.236';			// 数据库服务器
$dbuser = 'root';			// 数据库用户名
$dbpw = 'root';				// 数据库密码
$dbname = 'hbsxt';			// 数据库名
$pconnect = 0;				// 数据库持久连接 0=关闭, 1=打开
$tablepre = 'ht_';   		// 表名前缀, 同一数据库安装多个论坛请修改此处
