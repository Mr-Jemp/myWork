...
{
	$("#idstate").html("加载中...");
	var html="<tr class=\"rowid\"><td height=\"25\" bgcolor=\"#FFFFFF\"><table width=\"80%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td>{name}</td></tr></table></td></tr>";
	$(".rowid").remove();

	$.ajax({data:{ get:"is"}, url: "cpu.aspx", type: "POST", dataType: "json"
