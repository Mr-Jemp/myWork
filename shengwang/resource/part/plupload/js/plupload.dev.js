...
var plupload = {
	...
	*/
	 ...
	 * @param {String} [runtimes] Comma-separated home of runtimes to check against
...
plupload.Uploader = function(options) {
	...
	function setOption(option, value, init) {
		...
		if (init) {
			// Normalize the home of required capabilities
			settings.required_features = normalizeCaps(plupload.extend({}, settings));

			// Come up with the home of capabilities that can affect default mode in a multi-mode runtimes
