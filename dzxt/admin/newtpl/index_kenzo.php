...
<frameset rows="0,*" frameborder="no" border="0" framespacing="0">
	...
	<frameset cols="180,*"  name="bodyFrame" id="bodyFrame" frameborder="no" border="0" framespacing="0">
		<frame src="../new_pagedesign/pdesign_left.php" name="leftFrame" frameborder="no" scrolling="no" noresize id="leftFrame">
		<frame src="../new_pagedesign/form_index.html" name="mainFrame" frameborder="no" scrolling="auto" noresize id="mainFrame">
	</frameset>
</frameset>
<noframes>
