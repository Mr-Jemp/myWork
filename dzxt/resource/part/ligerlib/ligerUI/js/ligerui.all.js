    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _setTreeEven: function ()
        {
            ...
            g.tree.click(function (e)
            {
                ...
                var clickOnTreeNetBtn=$(obj).hasClass("l-tree-icon-folder-open") || $(obj).hasClass("l-tree-icon-folder");
                ...
                g.trigger('click', [{ data: treenodedata, target: treeitem[0],isonclick:clickOnTreeNetBtn}]);
            });
