$(function() {
    ...
    $("#bottom-menu").find("a").bind("click", function() {
        ...
        if ($(this).attr('id') == "zuzhi") {
			//getlefttree();
            $("#zuzhi-div").css("display", "block");
            $("#geren-div").css("display", "none");
            $("#shezhi-div").css("display", "none");
        }else if ($(this).attr('id') == "geren") {
            $("#zuzhi-div").css("display", "none");
            $("#geren-div").css("display", "block");
            $("#shezhi-div").css("display", "none");
        }else if ($(this).attr('id') == "shezhi") {
            $("#zuzhi-div").css("display", "none");
            $("#geren-div").css("display", "none");
            $("#shezhi-div").css("display", "block");
        }else
		{
			$("#zuzhi-div").css("display", "none");
			$("#geren-div").css("display", "none");
    ...
    $("#shezhi-div").find("a").bind("click", function() {
		...
		if($(this).attr('url')=='instantchat')
		{
			i_im_setShow('imbar');
			i_im_setOnShowPara('imbar');
			return;
		}
        $("#mainframe").attr("src", $(this).attr('url'));
    });
