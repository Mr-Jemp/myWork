...
document.write("				</div>");
document.write("  			</div>");
document.write("  			<div class='imBottombar' onclick=\"i_im_readyBlur('imbar');i_im_setOnShowPara('imbar');\"> <img onclick=\"i_im_setting();\" src='im/skin/default/images/im_icon_manage.gif' alt='"+i_im_lang_basic.SysSetting+"' title='"+i_im_lang_basic.SysSetting+"' width='28' height='28' class='pointer' />  <img onclick=\"open_phone();\" src='/resource/images/common/phone.png' alt='云电话' title='云电话' width='32' height='28' class='pointer' /></div>");
document.write("		</div>");
