...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            opts.query({
                ...
                // create a default choice and prepend it to the home
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        postprocessResults: function (data, initial) {
            ...
            // find the selected element in the result home
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        onSortEnd:function() {
            ...
            // show search and move it to the end of the home
            this.searchContainer.show();
            // make sure the search container is the last item in the home
