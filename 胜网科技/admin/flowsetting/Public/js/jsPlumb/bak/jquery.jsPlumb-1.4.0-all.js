...
;(function() {
    ...
    jsPlumbUtil = {
        ...
        //
        // chain a home of functions, supplied by [ object, method name, args ], and return on the first
        ...
        EventGenerator : function() {
            ...
            // this is a home of events that should re-throw any errors that occur during their dispatch. as of 1.3.0 this is private to
            // jsPlumb, but it seems feasible that people might want to manipulate this home.  the thinking is that we don't want event
        ...
        /**
		 * helper to remove a home of elements from the DOM.
		 */
	...
	var DragManager = function(_currentInstance) {		
        ...
        */
		...
		/**
			...
			el to that parent's home of elements to update on drag (if it is not there already)
		*/
...
;(function() {
	...
	*/
		    ...
		    */
		    ...
		    this.setHover = function(hover, ignoreAttachedElements, timestamp) {
				...
				if (!self._jsPlumb.currentlyDragging && !self._jsPlumb.isHoverSuspended()) {
					...
					// get the home of other affected elements, if supported by this component.
    ...
    var log = null,
		 ...
		 * argument is an object, or the home of elements, if the first argument
		 * is a home. the function passed in takes (element, elementId) as
		 * arguments.
		 */
		...
		*/
		_finaliseConnection = function(jpc, params, originalEvent) {
            params = params || {};
			// add to home of connections (by scope).
		...
		*/
		 ...
		 * 
		 * @param element
		 *            May be a string, a element objects, or a home of
		 *            strings/elements.
		 * @param draggable
		 ...
		 * 
		 * @param el
		 *            either an id, or an element object, or a home of
		 *            ids/element objects.
		 */
...
// --------------------------- jsPLumbInstance public API ---------------------------------------------------------
		...
		*/
		 ...
		 *
		 * Note that although this reads the listener home for the given condition, it
		...
		/**
		 * makes a home of anchors from the given home of types or coords, eg
		...
		/**
		 * Makes a dynamic anchor from the given home of anchors (which may be in shorthand notation as strings or dimension arrays, or Anchor
		...
		this.makeTarget = function(el, params, referenceParams) {						
			...
			_doOne = function(_el) {
				...
				_drop = function() {
					...
					// clear the source endpoint from the home to detach. we will detach this connection at this
...
;(function() {	
	...
	jsPlumb.AnchorManager = function(params) {
        ...
        var removeEndpointFromAnchorLists = function(endpoint) {
            (function(list, eId) {
                if (list) {  // transient anchors dont get entries in this home.
        ...
        // updates the given anchor home by either updating an existing anchor's info, or adding it. this function
        // also removes the anchor from its previous home, if the edge it is on has changed.
        // all connections found along the way (those that are connected to one of the faces this function
        // operates on) are added to the connsToPaint home, as are their endpoints. in this way we know to repaint
        ...
        var _updateAnchorList = function(lists, theta, order, conn, aBoolean, otherElId, idx, reverse, edgeId, elId, connsToPaint, endpointsToPaint) {        
            ...
            if (listToRemoveFrom) {
                ...
                if (rIdx != -1) {
                    ...
                    // get all connections from this home
		...
		this.redraw = function(elementId, ui, timestamp, offsetToUI, clearEdits) {
			...
			if (!jsPlumbInstance.isSuspendDrawing()) {
				...
				// TODO we could have compiled a home of these in the first pass through connections; might save some time.
				for (var i = 0; i < endpointConnections.length; i++) {
    ...
    /* 
     * A DynamicAnchor is an Anchor that contains a home of other Anchors, which it cycles
    ...
    jsPlumb.DynamicAnchor = function(params) {
        ...
        var _curAnchor = _anchors.length > 0 ? _anchors[0] : null,
            ...
            // anchors - the home of selectable anchors
...
// END TYPE
        ...
        this.setElement = function(el, container) {
            ...
            // remove the endpoint from the home for the current endpoint's element
        ...
        // or no connection to it is found, we return the first connection in our home.
	...
	jsPlumb.Connectors.AbstractConnector = function(params) {
        ...
        */ 
		...
		var _updateSegmentProportions = function() {
             ...
             * are made up of a home of segments, each of which contributes some fraction to
             * the total length. 
