...
<!-- Docs page layout -->
<div class="container">
<form method="post" id="saveform" name="saveform" action="<?php echo U('/index/parse');?>">
<input type="hidden" name="fields" id="fields" value="0">
<div class="row">
    <div class="well well-small">
<span class="pull-right">
    <a href="/index.php/demo.html" class="btn btn-success btn-small">使用实例演示</a>
</span>
...
<script type="text/javascript" charset="utf-8" src="/s/tp/wwwroot/Public/js/jquery-1.7.2.min.js?<?php echo ($_cjv); ?>"></script>

<script type="text/javascript" charset="utf-8" src="/s/tp/wwwroot/Public/js/ueditor/ueditor.config.js?<?php echo ($_cjv); ?>"></script>
<script type="text/javascript" charset="utf-8" src="/s/tp/wwwroot/Public/js/ueditor/ueditor.all.js?<?php echo ($_cjv); ?>"> </script>
<script type="text/javascript" charset="utf-8" src="/s/tp/wwwroot/Public/js/ueditor/lang/zh-cn/zh-cn.js?<?php echo ($_cjv); ?>"></script>
<script type="text/javascript" charset="utf-8" src="/s/tp/wwwroot/Public/js/ueditor/formdesign/leipi.formdesign.v4.js?<?php echo ($_cjv); ?>"></script>
<!-- script start-->  
<script type="text/javascript">
var leipiEditor = UE.getEditor('myFormDesign',{
           ...
           toolbars:[[
            ...
            //,iframeCssUrl:"/s/tp/wwwroot/Public/css/bootstrap/css/bootstrap.css" //引入自身 css使编辑器兼容你网站css
   ...
   parse_form:function(template,fields)
        ...
        if(leipiEditor.hasContents()){
           ...
           // alert("你点击了保存,这里可以异步提交....");
            ...
            //alert(parse_form);
             ...
             $.ajax({
                type: 'POST',
                url : '<?php echo U("/".$_controller."/parse");?>',
                //dataType : 'json',
    ...
    fnReview : function (){
        ...
        if(leipiEditor.hasContents()){
            ...
            document.saveform.action="<?php echo U('/index/preview');?>";
