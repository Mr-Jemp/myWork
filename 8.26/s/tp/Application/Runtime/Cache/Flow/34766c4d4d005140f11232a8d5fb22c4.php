...
<html>
 <head>
  ...
  <title>流程设计器</title> 
    ...
    <!--[if lte IE 6]>
    <link rel="stylesheet" type="text/css" href="/s/tp/wwwroot/Public/css/bootstrap/css/bootstrap-ie6.css">
    <![endif]-->
    <!--[if lte IE 7]>
    <link rel="stylesheet" type="text/css" href="/s/tp/wwwroot/Public/css/bootstrap/css/ie.css">
    <![endif]-->
...
<link rel="stylesheet" type="text/css" href="/s/tp/wwwroot/Public/flow/js/flowdesign/flowdesign.css"/>

<!--select 2-->
<link rel="stylesheet" type="text/css" href="/s/tp/wwwroot/Public/flow/js/jquery.multiselect2side/css/jquery.multiselect2side.css"/>
  ...
  <div class="navbar-inner">
    <div class="container">
      ...
      <div class="nav-collapse collapse">
        <ul class="nav">           
            <li><a href="#">正在设计【<?php echo ($one["flow_name"]); ?>】</a></li>
        </ul>
      </div>
...
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/js/jquery-1.7.2.min.js?<?php echo ($_cjv); ?>"></script>
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/css/bootstrap/js/bootstrap.min.js?<?php echo ($_cjv); ?>"></script>
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/js/jquery-ui/jquery-ui-1.9.2-min.js?<?php echo ($_cjv); ?>" ></script>
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/js/jsPlumb/jquery.jsPlumb-1.3.16-all-min.js?<?php echo ($_cjv); ?>"></script>
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/js/jquery.contextmenu.r2.js?<?php echo ($_cjv); ?>"></script>
<!--select 2-->
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/js/jquery.multiselect2side/js/jquery.multiselect2side.js?<?php echo ($_cjv); ?>" ></script>
<!--flowdesign-->
<script type="text/javascript" src="/s/tp/wwwroot/Public/flow/js/flowdesign/leipi.flowdesign.v3.js?<?php echo ($_cjv); ?>"></script>
<script type="text/javascript">
var the_flow_id = '<?php echo ($one["id"]); ?>';
...
$(function(){
    ...
    ajaxModal = function(url,fn)
    {
        ...
        attributeModal.find(".modal-body").html('<img src="/s/tp/wwwroot/Public/flow/images/loading.gif"/>');
    ...
    var _canvas = $("#flowdesign_canvas").Flowdesign({
                      ...
                      ,canvasMenus:{
                        "cmAdd": function(t) {
                            ...
                            var url = "<?php echo U('/Flow/Flowdesign/add_process');?>";
                        ...
                        "cmSave": function(t) {
                            ...
                            var url = "<?php echo U('/Flow/Flowdesign/save_canvas');?>";
                        ...
                        "cmHelp": function(t) {
                            mAlert('<ul><li><a href="doc.html" target="_blank">流程设计器 开发文档</a></li><li><a href="doc.html" target="_blank">表单设计器 开发文档</a></li><li><a href="demo.html" target="_blank">表单设计器 示例DEMO</a></li></ul>',20000);
                        }
                      ...
                      ,processMenus: {
                          ...
                          "pmDelete":function(t)
                          {
                              ...
                              {
                                    var activeId = _canvas.getActiveId();//右键当前的ID
                                    var url = "<?php echo U('/Flow/Flowdesign/delete_process');?>";
                          ...
                          {
                              var activeId = _canvas.getActiveId();//右键当前的ID
                              var url = "<?php echo U('/Flow/Flowdesign/attribute/id/"+activeId+"');?>";
                          ...
                          "pmForm": function(t) {
                                var activeId = _canvas.getActiveId();//右键当前的ID
                                var url = "<?php echo U('/Flow/Flowdesign/attribute/op/form/id/"+activeId+"');?>";
                                ajaxModal(url,function(){
                                    //alert('加载完成执行')
                                });
                          },
                          "pmJudge": function(t) {
                                var activeId = _canvas.getActiveId();//右键当前的ID
                                var url = "<?php echo U('/Flow/Flowdesign/attribute/op/judge/id/"+activeId+"');?>";
                                ajaxModal(url,function(){
                                    //alert('加载完成执行')
                                });
                          },
                          "pmSetting": function(t) {
                                var activeId = _canvas.getActiveId();//右键当前的ID
                                var url = "<?php echo U('/Flow/Flowdesign/attribute/op/style/id/"+activeId+"');?>";
                                ajaxModal(url,function(){
                                    //alert('加载完成执行')
                                });
                          }
